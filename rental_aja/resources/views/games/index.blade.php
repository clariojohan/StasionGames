    ...
    <div id="carouselExampleCaptions" class="carousel slide mt-5 pt-5" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active mx-auto" style="width = 270px;">
                <center><img src="{{url('images/banner/a.jpg')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/b.jpg')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/c.png')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/d.jpg')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/e.jpg')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/f.jpg')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/g.png')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/h.png')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
            <div class="carousel-item">
                <center><img src="{{url('images/banner/i.jpg')}}" class="d-block w-95" height="480px" width="720px" />
                </center>
            </div>
        </div>
