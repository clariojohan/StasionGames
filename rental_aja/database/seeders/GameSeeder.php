...
class GameSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $gameDescription3 = "As the sun sets on the last day of summer camp, the teenage counselors of Hackett's Quarry throw a party to celebrate. No kids. No adults. No rules.
